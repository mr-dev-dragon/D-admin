...
this.y < 100  ? h > 12 ? pp = (h *1)  : h > 8 ? pp = (h * 1)  : h > 6 ? pp = (h * 1)  : h > 4 ? pp = (h * 1)  : h > 2 ? pp = (h * 1)  : '' :
this.y < 200  ? h > 12 ? pp = (h * 5) : h > 8 ? pp = (h * 4)  : h > 6 ? pp = (h * 3)  : h > 4 ? pp =  (h * 2) : h > 2 ? pp = (h * 2)  : '' :
this.y < 300  ? h > 12 ? pp = (h *10) : h > 8 ? pp = (h * 8)  : h > 6 ? pp = (h * 6)  : h > 4 ? pp =  (h * 4) : h > 2 ? pp = (h * 3)  : '' :
this.y < 400  ? h > 12 ? pp = (h *15) : h > 8 ? pp = (h * 12) : h > 6 ? pp = (h * 9)  : h > 4 ? pp =  (h * 6) : h > 2 ? pp = (h * 4)  : '' :
this.y < 500  ? h > 12 ? pp = (h *20) : h > 8 ? pp = (h * 16) : h > 6 ? pp = (h * 12) : h > 4 ? pp =  (h * 8) : h > 2 ? pp = (h * 5)  : '' :
this.y < 600  ? h > 12 ? pp = (h *25) : h > 8 ? pp = (h * 20) : h > 6 ? pp = (h * 15) : h > 4 ? pp = (h * 10) : h > 2 ? pp = (h * 6)  : '' :
this.y < 700  ? h > 12 ? pp = (h *30) : h > 8 ? pp = (h * 24) : h > 6 ? pp = (h * 18) : h > 4 ? pp = (h * 12) : h > 2 ? pp = (h * 7)  : '' :
this.y < 800  ? h > 12 ? pp = (h *35) : h > 8 ? pp = (h * 28) : h > 6 ? pp = (h * 21) : h > 4 ? pp = (h * 14) : h > 2 ? pp = (h * 8)  : '' :
this.y < 900  ? h > 12 ? pp = (h *40) : h > 8 ? pp = (h * 32) : h > 6 ? pp = (h * 24) : h > 4 ? pp = (h * 16) : h > 2 ? pp = (h * 9)  : '' :
this.y < 1000 ? h > 12 ? pp = (h *45) : h > 8 ? pp = (h * 36) : h > 6 ? pp = (h * 27) : h > 4 ? pp = (h * 18) : h > 2 ? pp = (h * 10) : '' :
this.y < 1100 ? h > 12 ? pp = (h *50) : h > 8 ? pp = (h * 40) : h > 6 ? pp = (h * 30) : h > 4 ? pp = (h * 20) : h > 2 ? pp = (h * 11) : '' :
 "";
