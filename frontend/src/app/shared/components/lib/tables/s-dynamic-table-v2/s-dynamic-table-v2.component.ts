...
@Component({
  selector: 'app-s-dynamic-table-v2',
  templateUrl: './s-dynamic-table-v2.component.html',
  styleUrls: ['./s-dynamic-table-v2.component.scss']
})
export class SDynamicTableV2Component implements OnInit, OnChanges {
 ...
 let total_col:number =12
    ...
    this.widthSubject.subscribe(width => {
      ...
      this.width  < 100  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 200  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 300  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 400  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 500  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 600  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 700  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 800  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 900  ? (this.caprion_col_1 =12, this.caprion_col_2=12):
      this.width  < 1000 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1100 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1200 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1300 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1400 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1500 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1600 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1700 ? (this.caprion_col_1 =11, this.caprion_col_2=1) :
      this.width  < 1800 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 1900 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2000 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2100 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2200 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2300 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2400 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2500 ? (this.caprion_col_1 =10, this.caprion_col_2=2) :
      this.width  < 2600 ? (this.caprion_col_1 =9,  this.caprion_col_2=3) :
      this.width  < 2700 ? (this.caprion_col_1 =9,  this.caprion_col_2=3) :
      this.width  < 2800 ? (this.caprion_col_1 =9,  this.caprion_col_2=3) :
      this.width  < 2900 ? (this.caprion_col_1 =9,  this.caprion_col_2=3) :
      this.width <  3000 ? (this.caprion_col_1 =9,  this.caprion_col_2=3) :
       "";
